      ...
      <main>
        <section>
          ...
          <ul>
            ...
            <li>
              Whitepapers:{" "}
              <a href="https://whitepaper.gyfi.eth.link">
                whitepaper.gyfi.eth
              </a>
            </li>
            <li>
              Telegram Chat:{" "}
              <a href="https://t.me/GSDIofficial">
                t.me/GSDIofficial
              </a>
            </li>
            <li>
              Telegram Ann:{" "}
              <a href="https://t.me/GSDIAnnouncement">
                t.me/GSDIAnnouncement
              </a>
            </li>
            <li>
              Twitter:{" "}
              <a href="https://twitter.com/GsdiOfficial">
                twitter.com/GsdiOfficial
              </a>
            </li>
            <li>
              Medium:{" "}
              <a href="https://gsdiofficial.medium.com/">
                gsdiofficial.medium.com
              </a>
            </li>
            <li>
              Discord:{" "}
              <a href="https://discord.gg/yG7SDGVGzP">
